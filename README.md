prototyping a game with claude code due to general ignorance/hopefulness.
there are so many systems missing, but what works so far is:
- map generation (we got something workable)
- car controls (it flies and i am liking them so far)
- people wanting to go places to pick up and deliver
- scoring system (basic, useless, but it's something)
----
to be implemented:
...
- cool af customizable controls
but yo it takes time and multiple people to do this stuff, and i have no colleagues yet!
----
the controls at time of writing are as such:
- WASD - drone hover controls
- Q/E - drone hover yaw rotation
- space/C - drone hover upwards/downwards, rotate boosters
- Shift - boost
----
- up/down arrow - pitch down/upwards whole car
